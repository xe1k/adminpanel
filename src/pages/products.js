...
export default function Products() {
  ...
  return (
    <Layout>
      <Link
        className="bg-gray-300 py-2 px-3 rounded-md font-bold "
        href={"/products/new"}
      >
        Añadir producto
      </Link>
          ...
          {products.map((product) => (
            <tr>
              ...
              <td className="flex justify-center items-center space-x-4">
                ...
                <Link className="inline-flex bg-secondary text-white px-2 py-1 rounded-lg" href={"/products/delete/" + product._id}>
                  {" "}
